# -*- coding: utf-8 -*-
#
# marso documentation build configuration file, created by
...
project = u'marso'
copyright = u'marso contributors'

import marso
from marso.utils import version_info
...
latex_documents = [
    ('index', 'marso.tex', u'marso documentation',
     u'marso contributors', 'manual'),
]
...
man_pages = [
    ('index', 'marso', u'marso Documentation',
     [u'marso contributors'], 1)
]
...
texinfo_documents = [
    ('index', 'marso', u'marso documentation',
     u'marso contributors', 'marso', 'Awesome Python autocompletion library.',
     'Miscellaneous'),
]
